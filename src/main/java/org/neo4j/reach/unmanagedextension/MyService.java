...
public class MyService {
	...
	public String graphReachability(@PathParam("s") Long s,
			@PathParam("t") Long t) {
		result = this.database
				.execute("MATCH p=((s)-[*..50]->(t)) WHERE ID(s)=" + s
						+ " AND ID(t)=" + t + " RETURN length(p) LIMIT 1");
	...
	public String indexReachability(@PathParam("s") Long s,
			@PathParam("t") Long t) {
